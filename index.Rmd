...
```{bash, attr.source='.numberLines',eval=FALSE, class.source="nohide"}
nextflow main_12.nf -c nextflow_12.config --project "uppmax2023-2-3" --clusterOptions "-M snowy" 
```
...
```{bash, attr.source='.numberLines',eval=FALSE}
nextflow main_14.nf -c nextflow_14.config --project "uppmax2023-2-3" --clusterOptions "-M snowy" 
```
...
```{bash, attr.source='.numberLines',eval=FALSE, class.source="nohide"}
nextflow main_17.nf --inputmzml "/crex/proj/uppmax2023-2-3/metabolomics/mzMLData/*.mzML"
```
...
```{bash, attr.source='.numberLines',eval=FALSE, class.source="nohide"}
nextflow run main_18.nf --inputmzml "/crex/proj/uppmax2023-2-3/metabolomics/mzMLData/*.mzML" --qc 100
```
...
```{bash, attr.source='.numberLines',eval=FALSE, class.source="nohide"}
nextflow run main_18.nf -resume --inputmzml "/crex/proj/uppmax2023-2-3/metabolomics/mzMLData/*.mzML" --qc 100
```
...
After collecting the output from the previous process.
You can concatenate a it using the below example code under script section.
