...
*For part 1, you should send us the modified main.nf, nextflow.config and command used to run*
*For part 2, you will have to send us a main.nf, nextflow.config and a PCA plot!*
...
**For part 1, you should send us the modified main.nf, nextflow.config and the modified command used to run**
