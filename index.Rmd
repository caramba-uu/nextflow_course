...
```{bash, attr.source='.numberLines',eval=FALSE}
nextflow main.nf -profile uppmax_singularity --project "uppmax2026-1-94"
```
...
When running your pipeline, remember to use these flags and the config file from the part1 `-profile uppmax --project "uppmax2026-1-94"`.
For example
```{bash, attr.source='.numberLines',eval=FALSE, class.source="nohide"}
...
* You would also needall the  mzML files from this folder "/crex/proj/uppmax2026-1-94/metabolomics/mzMLData/" to a channel.
